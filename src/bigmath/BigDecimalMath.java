...
public class BigDecimalMath {
	...
	public static final BigDecimal THREE = valueOf(3);
	public static final BigDecimal MINUS_ONE = valueOf(-1);
	...
	public static BigDecimal tau(MathContext mathContext) {
		return TWO.multiply(pi(mathContext));
	}
